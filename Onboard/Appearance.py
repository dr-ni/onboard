...
class Theme:
    ...
    def __eq__(self, other):
        return other and \
               ...
               self.color_scheme_basename == other.color_scheme_basename and \
               self.key_label_font == other.key_label_font and \
               self.roundrect_radius == other.roundrect_radius
    ...
    def apply(self):
        ...
        config.key_label_font = self.key_label_font
        config.roundrect_radius = self.roundrect_radius
    ...
    def load(filename, system=False):
        ...
        try:
            ...
            try:
                ...
                text = utils.xml_get_text(domdoc, "key_label_font")
                if not text is None:
                    theme.key_label_font = text

                text = utils.xml_get_text(domdoc, "roundrect_radius")
                if not text is None:
                    theme.roundrect_radius = int(text)
...
<theme name="%s">
    ...
    <key_label_font>%s</key_label_font>
    <roundrect_radius>%d</roundrect_radius>
</theme>""" % (self.name,
        self.color_scheme_basename,
        self.key_label_font,
        self.roundrect_radius)
